...
public class TableGradientCell extends DefaultTableCellRenderer {
    ...
    public TableGradientCell() {
        this(Color.decode("#ec2F4B"), Color.decode("#ec2F4B"));
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (isSelected) {
            g2.setPaint(new GradientPaint(x, 0, Color.decode("#c2dcff"), width, 0, Color.decode("#fcd9fc")));
            g2.fill(new Rectangle2D.Double(0, 0, getWidth(), getHeight()));
        } else if (row % 2 == 0) {
            g2.setPaint(new GradientPaint(x, 0, Color.decode("#a1e4f0"), width, 0, Color.decode("#c2ffe9")));
            g2.fill(new Rectangle2D.Double(0, 0, getWidth(), getHeight()));
        }
